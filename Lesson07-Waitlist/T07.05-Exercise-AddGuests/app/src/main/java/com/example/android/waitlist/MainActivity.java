...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TODO (2) Set the Edit texts to the corresponding views using findViewByI
        mNewGuestNameEditText = (EditText) this.findViewById(R.id.person_name_edit_text);
        mNewPartySizedEditText = (EditText) this.findViewById(R.id.party_count_edit_text);
    ...
    public void addToWaitlist(View view) {
        ...
        if (mNewGuestNameEditText.getText().length() == 0 ||
                mNewPartySizedEditText.getText().length() == 0) {
         return;
        }
